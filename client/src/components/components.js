...
export function Button(props) {
  return (
    <div className="group" onClick={props.onClick}>
      <button className="button text-2xl mt-10 drop-shadow-md button bg-accent-100/80 inline-block rounded-lg px-10 py-2 hover:bg-accent-100/60 hover:rounded-md hover:drop-shadow-xl focus:bg-accent-100/40 focus:drop-shadow-2xl transition-all duration-100 ease-linear">
